...
const ViewAccounts = () => {
  ...
  const isFormOpen = showNewUserForm || editingUser;
        ...
        <ToastContainer position="top-end" className="p-3" style={{ zIndex: 1070 }}>
          ...
          {editingUser && (
            <Toast
              ...
              onClose={cancelEdit}
              className="position-fixed top-50 start-50 translate-middle p-3 bg-white shadow-lg border-0"
              style={{ minWidth: '600px', maxWidth: '800px', zIndex: 1075, borderRadius: '10px', animation: 'fadeIn 0.3s' }}
            >
              <Toast.Header closeButton closeVariant="white" style={{ backgroundColor: terraGreen, color: 'white', borderRadius: '10px 10px 0 0' }}>
                <strong className="me-auto">Edit User: {editingUser.email}</strong>
              </Toast.Header>
              <Toast.Body className="p-3">
                  ...
                  <div className="row g-2">
                    ...
                    {editForm.role === 'parkguide' && (
                      <>
                        ...
                        <div className="col-12 p-2 bg-white rounded-3 shadow-sm">
                          <span className="fw-bold mb-1 d-flex align-items-center" style={{ color: terraGreen }}>
                          ...
                          <div className="d-flex flex-wrap gap-1">
                            {['Mon', 'Tue', 'Wed', 'Thu', 'Fri'].map(day => (
                              <button 
                                key={day}
                                type="button" 
                                className={`btn rounded-pill px-2 py-1 ${
